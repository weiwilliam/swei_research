...
IMPLICIT NONE
  ...
  atm(1)%Temperature(94)= 285.8545
  atm(1)%Temperature(93)= 286.2815
  atm(1)%Temperature(92)= 287.707
  atm(1)%Temperature(91)= 289.1155
  DO i=86,90
     atm(1)%Temperature(i)=atm(1)%Temperature(i)+10.
  ENDDO
  DO i=57,85
     atm(1)%Temperature(i)=atm(1)%Temperature(i)+6.
  ENDDO  
