...
savedir=outpath+'/'+exp1+'/pdf_norm/'+aertype
...
for date in dlist:
    ...
    if (os.path.exists(infile0) and 
        ...
        print('Processing Radfile: %s' %(raddfile0))
...
satinfo_csv=lutpath+'/'+sensor+'_'+str(nchs0)+'_stats_new.csv'
...
# for chkwvn in chkwvn_list:
    ...
    omb0=omb_nbc0
    # omb0=tb_obs0-tb_sim0
    # aereff_fg0=tb_sim0-tb_clr0
    # aereff_obs0=tb_obs0-tb_clr0
    # aereff0=0.5*abs(aereff_fg0)+0.5*abs(aereff_obs0)

    omb1=omb_nbc1
    # omb1=tb_obs1-tb_sim1
    # aereff_fg1=tb_sim1-tb_clr1
    # aereff_obs1=tb_obs1-tb_clr1
    # aereff1=0.5*abs(aereff_fg1)+0.5*abs(aereff_obs1)
    ...
    if (plthist):            
        pltda_x1=omb1[pltmsk1==1]/obserr
        pltda_x2=omb0[pltmsk0==1]*varinv0[pltmsk0==1]
        pltda_x3=omb1[pltmsk1==1]*varinv1[pltmsk1==1]
