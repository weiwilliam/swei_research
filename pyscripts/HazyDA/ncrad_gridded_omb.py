...
grp0 = outdf0.groupby(['wavenumber','lat','lon']).agg({'omb_bc':['mean','count','var'],
                                                       'omb_nbc':['mean','count','var']})
grp1 = outdf1.groupby(['wavenumber','lat','lon']).agg({'omb_bc':['mean','count','var'],
                                                       'omb_nbc':['mean','count','var']})
